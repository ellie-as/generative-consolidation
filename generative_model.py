...
def build_encoder_decoder(latent_dim = 5): 
...
def reconstruction_loss_fn(x, t_decoded):
    # batch flatten collapses dimensions other than the batch, i.e. to (n_in_batch, 784)
    # K.binary_crossentropy returns result of dim (n_in_batch, 784) 
    # take the sum across the 784 pixels
    # take the mean across the batch
    return 0.5 * K.mean(K.sum(K.binary_crossentropy(
        K.batch_flatten(x), 
